...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={"verbose_name": "questionnaire", "verbose_name_plural": "surveys"},
        ),
        migrations.CreateModel(
            name="AnswerInteger",
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="questionnaire.AnswerBase",
                        on_delete=models.CASCADE,
                    ),
                ),
                ("body", models.IntegerField(null=True, blank=True)),
            ],
            bases=("questionnaire.answerbase",),
        ),
        migrations.CreateModel(
            name="AnswerRadio",
            fields=[
        ...
        migrations.AddField(
            model_name="response",
            name="questionnaire",
            field=models.ForeignKey(to="questionnaire.Survey", on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name="response",
            name="user",
        ...
        migrations.AddField(
            ...
            name="question",
            field=models.ForeignKey(to="questionnaire.Question", on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name="answerbase",
            name="response",
            field=models.ForeignKey(to="questionnaire.Response", on_delete=models.CASCADE),
        ),
    ]
