...
class Questionnaire(models.Model):
    ...
    def get_absolute_url(self):
        return reverse("questionnaire-detail", kwargs={"id": self.pk})
...
class Response(models.Model):
    ...
    class Meta(object):
        verbose_name = _("Set of answers to questionnaires")
        verbose_name_plural = _("Sets of answers to questionnaires")

    def __str__(self):
        msg = "Response to {} by {}".format(self.questionnaire, self.user)
